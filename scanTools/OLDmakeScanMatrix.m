...
% IanD edited one line to avoid needing communications toolbox
    p = inputParser;
    ...
    scanMatrix=reshape(1:scanDim(1)*scanDim(2), scanDim(2),scanDim(1))'; %added this line to avoid communications toolbox
